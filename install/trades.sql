CREATE TABLE IF NOT EXISTS `trades` (
  ...
  `com_fee` float,
  `total` float,
  `platform` enum('Alpha-9','Money Calendar Pro','Straight Line Profits','Weekly Money Call','The Money Zone','Fast Fortune Club','10 Minute Millionaire') CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `mate_id` varchar(50),
  PRIMARY KEY (`ID`)
