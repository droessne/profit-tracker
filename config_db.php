...
if ($dbconnection->connect_error) {
  ...
  $sql2 = "UPDATE defaults SET platforms = '".$platforms."', monthly_profit_percent_target = '".$monthly_profit_percent_target."', monthly_profit_percent_to_keep = '".$monthly_profit_percent_to_keep."', active_broker_id = '".$active_broker."' WHERE ID = '1';"; 
