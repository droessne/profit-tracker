    ...
    while($obj = $results->fetch_object()){
      ...
      if ( $skip != True ){
        ...
        echo "<tr bgcolor='".$color."' style='color: ".$font_color.";'>
              ...
              <td align='center' bgcolor='white' style='color: Black;'><table id='nochange' border=0><tr id='header'>
...
echo '<div class="container">
  <button align="left" type="button" data-toggle="collapse" data-target="#demo">Auth Information</button>
