  ...
  if (!$dbconnection->connect_errno) {
    ...
    while($obj = $results->fetch_object()){
      ...
      echo "<tr>
       ...
       echo "<tr><td></td><td></td><td align='center'><span style='font-size:.8em'>$obj->symbol</span></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td align='center'><span style='font-size:.8em'>".money_format($format_line, $trade_com)."</span></td><td align='center'><span style='font-size:.8em'>".money_format($format_line, $trade_total)."</span></td><td><span style='font-size:.8em'>".$percent."</span></td></tr>";
     }
     $results->close();
     unset($obj);
  }
