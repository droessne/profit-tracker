...
function get_call_spread($symbol, $strike, $strike2, $expire_date){
  ...
  if ($err) {
    ...
    $cur_data = get_call($symbol, $strike, $expire_date);
    $cur_data1 = get_call($symbol, $strike2, $expire_date);
...
#$results = get_call_spread('AGN','150', '160', '2019-05-17');
#print_r($results);
